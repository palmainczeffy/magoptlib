...
def test_get_sh_coeff():
    ...
    sh_coeff_actual=get_sh_coeff(real_sh, m_values, l_values, b_values)


    sh_coeff_expected= np.array([ 2.93702371,  0.4458267,  -0.79072192,  0.23739989,  0.89414749, 0.32482097])
